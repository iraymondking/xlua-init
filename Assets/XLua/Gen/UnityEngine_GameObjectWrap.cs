...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddMissingComponent", _m_AddMissingComponent);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddMissingComponent(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Type _cmpType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    
                        var gen_ret = gen_to_be_invoked.AddMissingComponent( _cmpType );
                        translator.Push(L, gen_ret);
