        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new AssetBundles.AssetBundleManager();
        ...
        static int _m_Cleanup(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.Cleanup(  );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assebundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsAssetBundleResident( _assebundleName );
		    ...
		    try {
                ...
                
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsAssetBundleLoaded( _assetbundleName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAssetBundleCache( _assetbundleName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsAssetLoaded( _assetName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAssetBundleAsyncCreater( _assetbundleName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetBundleAsync( _assetbundleName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.DownloadWebResourceAsync( _url );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.DownloadAssetFileAsync( _filePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.DownloadAssetBundleAsync( _filePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _streamingAssetsOnly = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.RequestAssetFileAsync( _filePath, _streamingAssetsOnly );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.RequestAssetBundleAsync( _assetbundleName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _unloadDependencies = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadUnusedAssetBundle( _assetbundleName, _unloadAllLoadedObjects, _unloadDependencies );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _unloadAllLoadedObjects = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadUnusedAssetBundle( _assetbundleName, _unloadAllLoadedObjects );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadUnusedAssetBundle( _assetbundleName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _unloadDependencies = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadAllUnusedResidentAssetBundles( _unloadAllLoadedObjects, _unloadDependencies );
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _unloadAllLoadedObjects = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadAllUnusedResidentAssetBundles( _unloadAllLoadedObjects );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.UnloadAllUnusedResidentAssetBundles(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
