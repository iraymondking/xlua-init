        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new AssetBundles.AssetBundleUtility();
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetStreamingAssetsFilePath( _assetPath );
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetStreamingAssetsFilePath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetStreamingAssetsDataPath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetStreamingAssetsDataPath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentFilePath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentFilePath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentDataPath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentDataPath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.CheckPersistentFileExsits( _filePath );
		    ...
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetAssetBundleFileUrl( _filePath );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.AssetBundlePathToAssetBundleName( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.PackagePathToAssetsPath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.IsPackagePath( _assetPath );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.AssetsPathToPackagePath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
