...
namespace XLua.CSObjectWrap
{
    ...
    public class MiniJSONJsonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MiniJSON.Json);
        ...
        {
            return LuaAPI.luaL_error(L, "MiniJSON.Json does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    string _json = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = MiniJSON.Json.Deserialize( _json );
		    ...
		    try {
                ...
                
                {
                    object _obj = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = MiniJSON.Json.Serialize( _obj );
