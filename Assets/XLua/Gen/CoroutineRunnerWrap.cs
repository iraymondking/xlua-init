...
namespace XLua.CSObjectWrap
{
    ...
    public class CoroutineRunnerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(CoroutineRunner);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CoroutineRunner();
        ...
        static int _m_YieldAndCallback(RealStatePtr L)
        {
		    try {
                ...
                CoroutineRunner gen_to_be_invoked = (CoroutineRunner)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    object _toYield = translator.GetObject(L, 2, typeof(object));
                    System.Action _callback = translator.GetDelegate<System.Action>(L, 3);
                    
                    gen_to_be_invoked.YieldAndCallback( _toYield, _callback );
