...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaUpdaterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaUpdater);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaUpdater constructor!");
        ...
        static int _m_OnInit(RealStatePtr L)
        {
		    try {
                ...
                LuaUpdater gen_to_be_invoked = (LuaUpdater)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnInit( _luaEnv );
        ...
        static int _m_Restart(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Restart( _luaEnv );
