...
{
    const string launchPrefabPath = "UI/Prefabs/Common/UILaunch.prefab";
...
//        CreateUpdater();
    ...
    {
        var go = new GameObject("AssetbundleUpdater");
    ...
    GameObject InstantiateGameObject(GameObject prefab)
    {
        ...
        var luanchLayer = GameObject.Find("UIRoot/LaunchLayer");
